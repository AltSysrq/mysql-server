...
static struct my_option my_long_options[] =
{
  ...
  {"no-auto-rehash", 'A',
   ...
   {"no-auto-vertical-output", OPT_NO_AUTO_VERTICAL_OUTPUT,
    "Don't automatically switch to vertical output mode if the result is wider "
    "than the terminal width.",
    &no_auto_vertical_output, &no_auto_vertical_output, 0, GET_BOOL, NO_ARG, 0,
    0, 0, 0, 0, 0},
  {"batch", 'B',
